...
//	-------- BEGIN QUESTIONS AND ANSWERS -------- //
	var insectQuestions = [ 
		'Which ant is considered the most dangerous ant in the world?', 
		'Which spider is considered the most dangerous spider in the world?', 
		'Which snake is considered the most dangerous snake in the world?',
		'Which of these is considered the most poisonous in the world?',
		'Which of these is considered the largest insect in the world?'
	]
...
// -------- END QUESTIONS AND ANSWERS -------- //
	...
	function newGame() {
		...
		$('.game-start .submit').on('click', function() {
			hideStartButton();
			getQuestionNumber();
			compileQuestions();
			displayQuestion();
...
//		
//		gameQuestions = gameQuestions.slice(useThisQuestionNumber, useThisQuestionNumber + 1);
//		console.log(gameQuestions + ' --- In the UPDATE QUESTION LIST function')
//	}
	...
	function displayQuestion() {	
		$('.active-question h2').text(gameQuestions[useThisQuestionNumber]);
	}
...
})  /// END OF ALL FUNCTIONS AND VARIABLES WITHIN JQUERY DOCUMENT READY EXECUTION CONTEXT ///
